...
const [const Directive(host: const {"(change)" : "onChange(\$event.target.checked)", "(blur)" : "onTouched()"}, providers: const [CHECKBOX_VALUE_ACCESSOR], selector: "input[type=checkbox][ngControl],input[type=checkbox][ngFormControl],input[type=checkbox][ngModel]")],
